...
{	
	...
	protected:
		...
		virtual void DestroyTree(TreeNode<T>*& pTree);
			// Destroys the bst tree.
		virtual void CopyTree(TreeNode<T>* pFromTree, TreeNode<T>*& pToTree);
			// Performs a preorder copy of the current tree to create a new one.
		virtual bool isThere(TreeNode<T>* pTree, const T& item);
